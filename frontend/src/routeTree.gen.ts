...
import { Route as LayoutExtractorImport } from './routes/_layout/Extractor'
...
const LayoutExtractorRoute = LayoutExtractorImport.update({
  path: '/Extractor',
  getParentRoute: () => LayoutRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_layout/Extractor': {
      preLoaderRoute: typeof LayoutExtractorImport
      parentRoute: typeof LayoutImport
    }
    '/_layout/admin': {
